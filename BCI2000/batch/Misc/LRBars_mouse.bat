...
start Operator               --OnConnect "-LOAD PARAMETERFILE ..\parms\LRBars.prm; LOAD PARAMETERFILE ..\parms\Fragment_MouseInput.prm"
...
start PythonApplication      --PythonAppClassFile=BCIApplication_LRBars.py
