...
class BciApplication(BciGenericApplication):
    ...
    def Construct(self):
        ...
        self.define_param(
            ...
            "PythonApp:Design   int    ControlDim=          1     1     1   2  // Control Dimension: 1=1D-Horizontal, 2=1D-Vertical, 3=2D (enumeration)",
        ...
        for i in range(0,self.kf['numMeasure']):
            ...
            self.define_state("KF_residual" + str(i) + "_f 32 0 0 0")
        ...
        self.define_state("KF_covarianceScalar_f    32 0 0 0",
                          "KF_residualScalar_f      32 0 0 0")
    ...
    def Preflight(self, sigprops):
        ...
        self.kf['residualScalarHistory'] = np.ones((self.kf['lengthHistory'],1))
        self.kf['residualScalar'] = 0
        self.kf['covarianceScalar'] = 0
        self.kf['residual'] = np.zeros((self.kf['numMeasure'],1))
    ...
    def exportStateVariables(self):
        ...
        for i in range(0,self.kf['numMeasure']):
            ...
            self.exportFloat("KF_residual" + str(i) + "_f",self.kf['residual'][i])
    ...
    def updateObjectMovement(self,objectState,externalInput,friction,viscosity,controlType,dt=1.0/40):
        ...
        if controlType == 1: # force-based control
            ...
            residual = (z - H.T*x)/np.asmatrix(self.screenSize).T # normalize by screen size
