...
%             FreqInterest=find(w>=LowCutoff & w<=HighCutoff);
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    Dat.eeg=cell(1);
    Dat.psd.sensor=cell(1);
    Dat.psd.source=cell(1);
    Dat.srateextract=hdr.Fs;
    Dat.srateprocess=fsProcess;
    Dat.begsample=cell(1);
    Dat.endsample=cell(1);
    ...
    Dat.event.bci2event=cell(1);
	Dat.event.event2bci=cell(1);
    Dat.controlsig.orig=cell(1);
    Dat.controlsig.norm=cell(1);
    Dat.controlsig.filt=cell(1);
...
%                 toc
            ...
            Parameters.cortex=handles.ESI.cortex;
            Parameters.clusters=handles.ESI.clusters;
